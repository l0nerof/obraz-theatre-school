...
function AboutUsSection() {
  return (
    <section className="pt-32 pb-16 xl:pt-8 xl:pb-[78px] lg:pt-8 lg:pb-16 md:pt-8 md:pb-10">
      <div className="max-w-[1174px] mx-auto flex gap-[109px] xl:flex-col xl:max-w-[750px] xl:gap-6 xl:items-center lg:max-w-[704px] lg:flex-col lg:gap-6 lg:items-center md:max-w-[448px] md:flex-col md:gap-6 md:items-center">
        <div className="uppercase text-white xl:text-center lg:text-center md:text-center sm:text-center">
        ...
        <div>
          <iframe
            width="599"
            height="303"
            className="border-primary rounded-md border-4 md:w-[448px]"
