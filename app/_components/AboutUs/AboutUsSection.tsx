...
function AboutUsSection() {
  return (
    <section className="pt-32 pb-16 xl:pt-8 xl:pb-[78px] lg:pt-8 lg:pb-16">
      <div className="max-w-[1174px] mx-auto flex gap-[109px] xl:flex-col xl:max-w-[750px] xl:gap-6 xl:items-center lg:max-w-[704px] lg:flex-col lg:gap-6 lg:items-center">
