...
export default function ActualItem({ children, type }: IActualItemProps) {
  return (
    <li>
      <Link href="/">
        <div className="bg-[url('/shows/show.jpg')] bg-cover bg-no-repeat w-[400px] h-[200px] sm:bg-center sm:w-[288px] sm:h-[200px]">
        ...
        <h3 className="mt-3 font-bold text-2xl leading-none sm:text-base">
          {children}
        </h3>
      </Link>
    </li>
