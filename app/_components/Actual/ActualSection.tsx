...
export default function ActualSection() {
  return (
    <section className="py-8 bg-primary">
      <div className="max-w-[1296px] mx-auto xl:max-w-[904px] lg:max-w-[704px] md:max-w-[448px]">
        <div className="flex justify-between gap-6 items-center md:flex-col md:items-start">
