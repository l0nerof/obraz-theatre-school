    ...
    <section className="pb-32 xl:pb-16 first-letter:lg:pb-16 md:pb-10 sm:pb-6">
      <div className="max-w-[1148px] mx-auto flex justify-between gap-5 xl:max-w-[750px] xl:flex-col lg:max-w-[704px] lg:flex-col md:max-w-[448px] md:flex-col sm:max-w-[272px] sm:flex-col">
        <div className="basis-2/4">
          <div>
            <h2 className="text-white uppercase font-semibold text-5xl xl:text-center lg:text-center md:text-center md:text-[32px] sm:text-center sm:text-[32px]">
              Досі вагаєшся?
            </h2>
          ...
          <div className="mt-8">
            <h3 className="text-white uppercase font-medium text-xl xl:text-center lg:text-center md:text-center sm:text-center">
        ...
        <div className="h-full text-white w-[400px] basis-2/5 text-center xl:hidden lg:hidden md:hidden sm:hidden">
          <AdvantagesSlider />
        </div>
      </div>
    </section>
